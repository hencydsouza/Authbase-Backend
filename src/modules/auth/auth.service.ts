...
import { calculateExpirationDate, fourtyFiveMinutesFromNow, ONE_DAY_IN_MS } from "../../common/utils/date-time";
...
export class AuthService {
    ...
    public async refreshToken(refreshToken: string) {
        ...
        const sessionRequiredRefresh = session.expiresAt.getTime() - now <= ONE_DAY_IN_MS;
